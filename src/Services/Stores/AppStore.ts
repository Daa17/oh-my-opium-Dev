...
export class AppStore {
  @observable requestsAreNotAllowed: boolean =
    authStore.blockchainStore.requiredNetworkName !==
      authStore.blockchainStore.currentNetworkName ||
    !authStore.blockchainStore.address;
  @observable wrappingPopupIsOpened: boolean = false;
  @observable currentPoolId: string = "";
  ...
  constructor() {
    reaction(
      () => authStore.blockchainStore.address,
      this.setRequestsAreNotAllowedReaction
    );
    reaction(
      () => authStore.blockchainStore.requiredNetworkName,
      this.setRequestsAreNotAllowedReaction
